            ...
            <div class="container">
                ...
                <div class="content">
                    ...
                    <p style="font-size: 16px; line-height: 1.6; color: #333;">
                        Great news! <strong>{referred_user.full_name}</strong> (Username: <strong>{referred_user.email}</strong>) just signed up using your referral code 
                        <span style="background: #fff3cd; padding: 3px 8px; border-radius: 3px; font-family: monospace;">{referrer.referral_code}</span>, 
                        and your referral bonus of <strong>${bonus_amount:.2f}</strong> has been credited to your account!
                    </p>

        ...
        try:
            ...
            if referral_code:
                try:
                    ...
                    # New user gets $20 welcome bonus (do not add to spendable balance)
                    user.balance = Decimal('0.00')
                    user.referral_bonus = Decimal('20.00') # Track as bonus ONLY
                    
                    # Referrer gets $30 bonus (do not add to spendable balance)
            ...
            if referral_code and user.referred_by:
                messages.success(request, f'Account created successfully! Welcome bonus of ${user.balance:.0f} credited. Referred by: {user.referred_by.full_name}')
            elif referral_code and user.balance > 0:
